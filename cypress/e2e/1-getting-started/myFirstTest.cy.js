// const navbarText = Cypress.expose('navbarText');
// const token = 'abcd123'
...
context('My First Test', () => {
  ...
  //     // cy.visit('/')
  //     // get is like an element selector essentially -- gets all h1s
  //     // if you want to get a class (like container) just use .container
  //     // same thing with ids and # before
  //     // should checks whether or not it exists

  //     cy.get('h1').should('exist');
  // })

  // it('renders the correct h1 text', () => {
  //     // check that h1 contains the correct text
  //     cy.get('h1').should('contain.text', 'Kitchen Sink');
  // })

  // it('renders a paragraph under the h1', () => {
  //     // get all containers
  //     // take the 2nd one (0 indexed)
  //     // find finds all elements
  //     // should checks that it exists
  //     cy.get('.container').eq(1).find('p').should('exist');
  // })

  // it('renders a section with the correct elements', () => {
  //     // get container at index 2 (3rd one)
  //     // within means we are only targeting elemnts within 3rd container
